...
var ImageProcessApp = App('ImageProcessApp', {
  init: function (options) {
    ...
    this.imageCollection = options_.imageCollection || this.db.collection(options_.dbCollection);
    ...
    // upload app instance
    options_.db = this.db;
    options_.imageCollection = this.imageCollection;
  ...
  processImage: function (id, date, options) {
    ...
    var query = processedImageModel.attr(['id', 'date']);
